...
go get github.com/yieldbot/sensuplugin/sensuhandler
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.hostname = 'sensumailer'

  config.vm.provision 'shell', inline: $script, privileged: false
  config.vm.synced_folder '.', '/opt/gopath/src/github.com/yieldbot/sensumailer'
